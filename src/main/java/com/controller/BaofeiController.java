...
public class BaofeiController {
    ...
    */
    @RequestMapping("/save")
    public R save(@RequestBody BaofeiEntity baofei, HttpServletRequest request) throws Exception {
        ...
        baofei.setTransactionHash(hash);
        ...
        params.put("baofeiNumber",baofei.getBaofeiNumber());
        params.put("baofeiContent",baofei.getBaofeiContent());
        ...
        transactionEntity.setTransactionType("资产报废");
        ...
        funcParam.add(baofei.getShangpinId());
        funcParam.add(baofei.getBaofeiNumber());
        funcParam.add(baofei.getBaofeiContent());

        Dict dict = weBASEService.scrapAsset(funcParam);
